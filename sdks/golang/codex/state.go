...
const (
	...
	// TransitionSessionConfigured transitions from Starting to Ready.
	TransitionSessionConfigured
	// TransitionUserMessageSent transitions from Ready to Processing.
	TransitionUserMessageSent
	// TransitionTurnComplete transitions from Processing to Ready.
...
var validTransitions = map[SessionState]map[StateTransition]SessionState{
	...
	StateStarting: {
		TransitionSessionConfigured: StateReady,
		TransitionClosed:            StateClosed,
	},
	StateReady: {
	...
	StateProcessing: {
		TransitionTurnComplete: StateReady,
		TransitionClosed:       StateClosed,
	},
	StateClosed: {},
}
