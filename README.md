...
Claude SDK and a lot of tools are built around Claude CLI. However, the underlying protocol is largely undocumented, and prevents implementation of SDK in other languages. This project helps unlock that possiblity.
